...
const classInsects = {
  ...
  "統資一乙":{icon:"🐝",zh:"蜜蜂",en:"Honeybee"},
  "統資二甲":{icon:"✨",zh:"螢火蟲",en:"Firefly"},
  "統資二乙":{icon:"𓆦",zh:"蜻蜓",en:"Dragonfly"},
  "統資三甲":{icon:"🦋",zh:"鳳蝶",en:"Swallowtail"},
  "統資三乙":{icon:"🌿",zh:"螳螂",en:"Mantis"},
  "統資四甲":{icon:"🪲",zh:"鍬形蟲",en:"Stag beetle"},
  "統資四乙":{icon:"🪲",zh:"獨角仙",en:"Rhinoceros beetle"},
  "碩研一":{icon:"♬",zh:"蟬",en:"Cicada"},
  "碩研二":{icon:"𓆦",zh:"豆娘",en:"Damselfly"}
};
const seedVoices = [
